        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('booking.store', ['lapangan' => $lapangan]) }}" method="POST" id="bookingForm">
                            @csrf                            
                            <div class="mb-3">
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-book btn-lg">Booking Sekarang</button>
                                <a href="{{ route('booking.index') }}" class="btn btn-danger btn-view btn-lg    ">Lihat Daftar Booking</a>
                            </div>
                        </form>
                    </div>
                </div>
